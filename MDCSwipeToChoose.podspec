Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/acegreen/MDCSwipeToChoose'
  s.license = 'MIT'
  s.author = { 'acegreen' => 'acegreen1989@icloud.com' }
  s.social_media_url = 'https://twitter.com/acegreen1989'
  s.source = { :git => 'https://github.com/acegreen/MDCSwipeToChoose.git', :tag => "v#{s.version}" }
